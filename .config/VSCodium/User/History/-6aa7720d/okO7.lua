...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 5, stiffness = 71.2633, dampening = 15.8273644 })
hl.curve("rubber",         { type = "spring", mass = 50, stiffness = 70,      dampening = 10         })

-- Animations
hl.animation({ leaf = "global",              enabled = true, speed = 3, bezier = "easeInOutCuint"                 })
hl.animation({ leaf = "windows",             enabled = true, speed = 3, spring = "easy",  style = "gnomed" })
hl.animation({ leaf = "workspaces",          enabled = true, speed = 4, spring = "easy", style = "slidefadevert 15%" })
