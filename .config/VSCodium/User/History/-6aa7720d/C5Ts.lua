...
hl.animation({ leaf = "windows",             enabled = true, speed = 3, spring = "easeInOutCuint",  style = "slide" })
hl.animation({ leaf = "workspaces",          enabled = true, speed = 5, bezier = "easeInQuart", style = "slide 20%" })
