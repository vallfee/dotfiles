...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 4, stiffness = 71.2633, dampening = 15.8273644 })
...
hl.animation({ leaf = "windows",             enabled = true, speed = 3, spring = "easy",  style = "popin 10%" })
hl.animation({ leaf = "workspaces",          enabled = true, speed = 4, spring = "easy", style = "slide 15%" })
