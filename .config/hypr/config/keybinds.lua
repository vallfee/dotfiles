...
hl.bind("ALT + SPACE",     hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
...
hl.bind(mainMod .. " + A",          hl.dsp.exec_cmd(launchPrefix .. MENU))
hl.bind(mainMod .. " + P",          hl.dsp.exec_cmd("/home/vallfee/.config/waybar/restart.sh"))
-- hl.bind(mainMod .. " SHIFT + S",    hl.dsp.exec_cmd("grim -g "$(slurp)" ~/screenshot.png"))
hl.bind(mainMod .. "+ O",           hl.dsp.exec_cmd("home/vallfee/.config/swaync/restart.sh"))
----------------------------±
---- HARDWARE CONTROLS ----
---------------------------
